CREATE TABLE CUSTOMERS(
        ...
        ,ZIPCODE                VARCHAR(10)
        ,COUNTRY                VARCHAR(50)
        ,SALESEMPLOYEENUMBER    VARCHAR(50)
...
CREATE TABLE ORDERDETAILS(
        ORDERNUMBER             NUMERIC(11)
        ,PRODUCTCODE            VARCHAR(15)
        ,ORDEREDQUANTITY        NUMERIC(11)
